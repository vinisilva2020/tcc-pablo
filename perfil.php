...
if (isset($_POST['login'])) {
    ...
    $sql = "UPDATE usuarios SET nomeusuario = '$usuario' WHERE u_id = '$id' ";
                    ...
                    <div class="card shadow-2-strong" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="text" name="usuario" value="<?php echo $_SESSION['nomeusuario'] ?>" placeholder="Nome de Usuário" class="form-control form-control-lg" />
                            ...
                            <input class="btn btn-danger btn-lg btn-block" value="Atualizar perfil" type="submit" name="login">
                        </div>
                    </div>
                </div>
            </div>
